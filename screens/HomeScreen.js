    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top', 'left', 'right']}>
      ...
      >
        ...
        <View style={{opacity: 0.88}}>
          ...
          <View style={[styles.calculatorCard, { backgroundColor: colors.cardBackground }]}>
            {/* {console.log('Calculator card rendered')} */}
            <Text style={[styles.calculatorTitle, { color: colors.text }]}>Currency Calculator</Text>
            <View style={styles.calculatorRow}>
              <View style={styles.calculatorRow}>
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                  <View style={{ flex: 1 }}>
                    <Text style={[styles.calculatorLabel, { color: colors.textMuted }]}>Currency</Text>
                    <TouchableOpacity
                    ...
                    >
                      ...
                      <Text style={[styles.currencySelectorText, { color: colors.text }]}>{localCurrency}</Text>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={[styles.calculatorLabel, { color: colors.textMuted }]}>Amount</Text>
                    <TextInput
                      ref={amountInputRef}
                      style={[styles.calculatorInput, { width: '100%', backgroundColor: colors.background, borderColor: colors.border, color: colors.text }]}
            ...
            <View style={styles.calculatorRow}>
              ...
              <Text style={[styles.calculatorValue, { color: colors.text }]}>{usdcValue ? `$${usdcValue}` : '--'}</Text>
              <Text style={[styles.calculatorLabel, { marginLeft: 16, color: colors.textMuted }]}>EURC:</Text>
              <Text style={[styles.calculatorValue, { color: colors.text }]}>{eurcValue ? `€${eurcValue}` : '--'}</Text>
            </View>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginVertical: 12 }}>
              <TouchableOpacity
                style={[styles.exchangeButton, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}
                onPress={openConvertModal}
                activeOpacity={0.8}
              >
                <View style={styles.exchangeButtonContent}>
                  <Ionicons name="swap-horizontal" size={20} color={colors.primary} />
                  <Text style={[styles.exchangeButtonText, { color: colors.primary }]}>Convert</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
      ...
      {showTransactionDetails && selectedTransaction && (
        <Animated.View style={[styles.transactionDetailsOverlay, { opacity: transactionModalOpacity }]}>
          <BlurView intensity={40} tint="dark" style={styles.transactionDetailsOverlay}>
          <View style={styles.transactionDetailsBackdrop}>
            <View style={[styles.transactionDetailsContainer, { backgroundColor: colors.cardBackground }]}>
              <View style={styles.transactionDetailsHeader}>
                ...
                />
                <Text style={[Typography.h4, styles.transactionDetailsTitle, { color: colors.textPrimary }]}>
                  Transaction Details
                </Text>
                <TouchableOpacity
                    onPress={handleCloseTransactionDetails}
                  style={[styles.transactionDetailsCloseButton, { backgroundColor: colors.background }]}
                >
                  <Ionicons name="close" size={20} color={colors.textMuted} />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.transactionDetailsContent}>
                <View style={styles.transactionDetailsRow}>
                  <Text style={[styles.transactionDetailsLabel, { color: colors.textMuted }]}>Type:</Text>
                  <Text style={[styles.transactionDetailsValue, { color: colors.textPrimary }]}>
                    {selectedTransaction.type.charAt(0).toUpperCase() + selectedTransaction.type.slice(1)}
                  </Text>
                </View>
                
                <View style={styles.transactionDetailsRow}>
                  <Text style={[styles.transactionDetailsLabel, { color: colors.textMuted }]}>Amount:</Text>
                  <Text style={[
                    styles.transactionDetailsValue, 
                    { color: (selectedTransaction.type === 'received' || selectedTransaction.type === 'deposit') ? colors.success : colors.error }
                  ]}>
                    {(selectedTransaction.type === 'received' || selectedTransaction.type === 'deposit') ? '+' : '-'}
                    {formatCurrency(selectedTransaction.sourceAmount, selectedTransaction.sourceCurrency)}
                  </Text>
                </View>
                
                <View style={styles.transactionDetailsRow}>
                  <Text style={[styles.transactionDetailsLabel, { color: colors.textMuted }]}>Date:</Text>
                  <Text style={[styles.transactionDetailsValue, { color: colors.textPrimary }]}>
                ...
                <View style={styles.transactionDetailsRow}>
                  <Text style={[styles.transactionDetailsLabel, { color: colors.textMuted }]}>Time:</Text>
                  <Text style={[styles.transactionDetailsValue, { color: colors.textPrimary }]}>
                ...
                {selectedTransaction.recipientName && (
                  <View style={styles.transactionDetailsRow}>
                    <Text style={[styles.transactionDetailsLabel, { color: colors.textMuted }]}>
                ...
                {selectedTransaction._id && (
                  <View style={styles.transactionDetailsRow}>
                    <Text style={[styles.transactionDetailsLabel, { color: colors.textMuted }]}>Transaction ID:</Text>
                    <Text style={[styles.transactionDetailsValue, { color: colors.textPrimary, fontSize: 12 }]}>
                      {selectedTransaction._id}
                    </Text>
                  </View>
                )}
              ...
              <TouchableOpacity 
                style={[styles.transactionDetailsButton, { backgroundColor: colors.primary }]}
                onPress={handleCloseTransactionDetails}
                activeOpacity={0.8}
              >
                <Text style={[Typography.button, { color: colors.textInverse }]}>Close</Text>
              </TouchableOpacity>
            </View>
          </View>
        </BlurView>
...
const styles = StyleSheet.create({
  ...
  transactionCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: Colors.cardBackground + 'B3', // 0.7 opacity
    borderRadius: 16,
    marginVertical: 6,
    width: '100%',
    paddingVertical: 14,
  ...
  calculatorInput: {
    ...
    paddingVertical: 12,
    minWidth: 70,
    height: 48, // Match the height of currencySelectorRow
    textAlign: 'right',
  },
  calculatorValue: {
    ...Typography.bodyRegular,
  ...
  currencySelectorRow: {
    ...
    marginRight: 8,
    minWidth: 120,
    height: 48, // Match the height of calculatorInput
    shadowColor: Colors.shadowLight,
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.08,
    shadowRadius: 4,
