...
const WithdrawModal = ({ visible, onClose, currentCurrency, currentBalance, onCurrencyChange }) => {
  ...
  const withdrawOptions = [
...

    {
      ...
      description: 'Withdraw in stable coins',
      icon: 'logo-bitcoin',
    ...
    },
    {
      id: 'cash_pickup',
      title: 'Cash Pickup',
      description: 'At your nearest location',
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.modalHeader}>
            <TouchableOpacity 
              ...
              onPress={onClose}
              accessibilityLabel="Close withdraw money modal"
              accessibilityHint="Double tap to close the withdraw money screen"
                          ...
                          <View style={styles.cardStackCardContent}>
                            ...
                            <TouchableOpacity
                              onPress={(e) => {
                                e.stopPropagation();
                                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                                setCurrentCardIndex(prev => prev === 0 ? withdrawOptions.length - 1 : prev - 1);
                              }}
                              activeOpacity={0.7}
                            ...
                            <TouchableOpacity
                              onPress={(e) => {
                                e.stopPropagation();
                                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                                setCurrentCardIndex(prev => prev === withdrawOptions.length - 1 ? 0 : prev + 1);
                              }}
                              activeOpacity={0.7}
            ...
            <View style={[
              ...
              <View style={styles.cardStackDots}>
                {withdrawOptions.map((_, index) => (
                  ...
                  >
                    <Ionicons 
                      name={withdrawOptions[index].icon} 
                      size={16} 
