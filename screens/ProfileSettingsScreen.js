...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Alert, Platform, SafeAreaView, Linking } from 'react-native';
...
const ProfileSettingsScreen = ({ navigation }) => {
  const { user, logout, isLoading: authIsLoading } = useContext(AuthContext);
